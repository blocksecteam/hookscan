...
from hookscan.components.evm_instructions import Call, Callcode, Delegatecall, Revert, Staticcall
from hookscan.components.instruction import Instruction, UnreachableInst
