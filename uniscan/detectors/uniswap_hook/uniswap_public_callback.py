...
from uniscan.components.evm_instructions import Address, Caller, Eq, Return
...
from uniscan.detectors.uniswap_hook.uniswap_get_callback import UniswapGetCallback
